...
CHORDS = ((0,), (0, 5, 7), (0, 4, 7, 10), (0, 5, 7, 10), (0, 3, 7),
          (0, 3, 7, 10, 14), (0, 3, 7, 10), (0, 4, 7, 9), (0, 7),
          (0, 7, 14), (0, 4, 8), (0, 3, 6, 9), (0, 4, 7),
          (0, 4, 7, 10, 14), (0, 4, 7, 11))
...
def send(tm, am, chords=False):
    ...
    if not chords: #single note
        ...
        if tm == 0:
            ...
            #TODO: read next 4 pads to right of root, if possible.
            #TODO: convert to binary using headings: 3210
            #TODO: notes = CHORDS[idx]
